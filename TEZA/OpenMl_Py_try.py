...
if __name__ == '__main__':
   ...
   # % load_ext
    ...
    global global_algo, global_env_name, path_pycharm, Train, Test, task_id

    path_pycharm = '/home/mor/project/TEZA/'#'/Users/zlililaor/Desktop/MorTeza-main/TEZA/'
    ...
    user_dict = OrderedDict([
        ('n_estimators', {'range_val': [2, 500], 'init_val': 250})
    ...
    # for expiraments: put all hyper params into a OrderedDict, easily expandable
    params = OrderedDict(
        # lr = [.01, .001],
        batch_size=[batch_size]
        # shuffle = [False]
