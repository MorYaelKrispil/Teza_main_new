...
class DQNAgent(object):
    def __init__(self, gamma, epsilon, lr, n_actions, input_dims,
        ...
        self.init_batch_size = batch_size #new for mrmory atl
    ...
    def learn(self,i,episodes_number):
        ...
        if self.memory.mem_cntr < self.init_batch_size: # was self.batch_size atl
            return

        self.replace_target_network()
        
        
        self.batch_size=self.memory.mem_cntr # atl new for sampel all mem as batch
